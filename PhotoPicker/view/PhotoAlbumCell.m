...
- (void)s_setupCellView {
    ...
    self.titleLab = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(self.imgView.frame) + 15 , 0,WIDTH - CGRectGetWidth(self.imgView.frame) - 15 * 2 - 30, 54)];
    [self.contentView addSubview:self.titleLab];
    
    
    self.underLine = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(self.imgView.frame) + 15 , CGRectGetMaxY(self.titleLab.frame),WIDTH - CGRectGetWidth(self.imgView.frame) - 15 * 2, 1)];
