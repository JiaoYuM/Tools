...
- (void)setContentView:(UIView *)contentView {
    ...
    if (_contentView.superview != _popupView) {
        //CGPointZero  默认0顶部对其
        _contentView.frame = (CGRect){.origin = CGPointMake(0, 0), .size = contentView.frame.size};
             ...
             usingSpringWithDamping:0.6
              initialSpringVelocity:0.2
                         ...
                         animations:^{
                             ...
                             self.popupView.center = [self finishedCenterPoint];
    ...
    if (isElasticAnimated) {
        ...
        [UIView animateWithDuration:duration1
                         ...
                         animations:^{
                             ...
                             self.popupView.center = [self elasticSpacePoint:30];
                             ...
                             [UIView animateWithDuration:duration2
                                              ...
                                              animations:^{
                                                  ...
                                                  [self maskAlphaInitial];
                                                  self.popupView.center = [self dismissedCenterPoint];
